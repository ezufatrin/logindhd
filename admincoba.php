                            ...
                            { 
                                ...
                                { $NoPlasma++;?>				
                                    <div class="col-lg-6 col-12 h-75">	
                                        ...
                                        <!-- Input Data Harian -->
                                        <a class="btn btn-success btn-block text-center mt-3" data-toggle="collapse" href="#collapseHarian<?php echo $i; ?>" role="button" aria-expanded="false" aria-controls="collapseExample">
                                        Input Data Harian</a> 
...
<!-- INPUT DATA -->							
                        <div class="tab-pane" id="inputdata">
                            <!-- Input jumlah kolam -->
							<a class="ezufont btn btn-info btn-block mb-1 mt-2" data-toggle="collapse" href="#collapseJumlahKolam" role="button" aria-expanded="false" aria-controls="collapseExample">
