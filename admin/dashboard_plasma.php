    ...
    { $NoPlasma++;?>				
        <div class="col-lg-6 col-12 h-75">	
            <div class="small-box bg-info "> <!-- small box -->
                ...
                <a class="btn btn-success mb-1 ml-1" href="admin.php?id=<?php echo $dataKolam[$i]['id']; ?>" onclick="return  confirm('Anda yakin menghapus kolam Y/N')">Hapus Kolam </a>

                <?php 

                if(!($dataKolam[$i]['tanggal_penyelesaian'] == "0000-00-00"))
                { ?>
                <a href="#collapseExamplemPlasma<?php echo $i; ?>" data-toggle="collapse" class="small-box-footer">Selengkapnya<i class="fas fa-arrow-circle-right"></i></a><?php 
                } ?>
