...
<div class="form-group">
	...
	<label class="col-sm-2 control-label ">Judul<span style="color:red">*</span></label>
	<div class="col-sm-4">
	<input type="text" name="title" class="form-control" required>
	</div>

	<label class="col-sm-2 control-label">Lampiran File<span style="color:red"></span></label>
	<div class="col-sm-4">
